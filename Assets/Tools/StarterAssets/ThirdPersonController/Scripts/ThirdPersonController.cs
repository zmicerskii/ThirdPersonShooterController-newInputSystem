...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [SerializeField] 
        private Vector3 _idleCenterCharacterController = new Vector3(0f, 0.86f, 0.2f);
        [SerializeField] 
        private float _idleHeightCharacterController = 1.8f;
        [SerializeField] 
        private Vector3 _crouchCenterCharacterController = new Vector3(0f, 0.5f, 0.2f);
        [SerializeField] 
        ...
        {
            var isCanJump = Grounded && !_isCrouch;
            if (isCanJump)
            {
                _fallTimeoutDelta = FallTimeout;
